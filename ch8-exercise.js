...
import { Container, Maybe, Either, Left, Right, either, left, trace, IO } from './support/index.js'
...
var ex1 = (x, f) => map(add(x), f)

console.log(ex1(2, Container.of(1)))
...
const register = compose(
  either(IO.of, compose(map(showWelcome), trace('trace1'), save)),
